...
class RecipebasedonlikesView extends GetView<RecipebasedonlikesController> {
  @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Obx(() {
          ...
          if (controller.recipesByLiked.isEmpty) {
            return Center(child: Text('You havent liked any recipes yet'));
          }
          ...
          return GridView.builder(
            ...
            itemCount: controller.recipesByLiked.length,
            itemBuilder: (context, index) {
              var recipe = controller.recipesByLiked[index];
