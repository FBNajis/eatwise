    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Obx(() {
          ...
          if (controller.recipesByBudget.isEmpty) {
            return Center(child: Text('No recipes found for this budget'));
          }
          ...
          return GridView.builder(
            ...
            itemCount: controller.recipesByBudget.length,
            itemBuilder: (context, index) {
              var recipe = controller.recipesByBudget[index];
